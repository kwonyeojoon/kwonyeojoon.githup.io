...
PROJECT_ROOT = "/Users/kwonyeojoon0221/Desktop/Visual_Studio_Code/project/project_clang/ui_1"
...
# C 프로그램 경로 설정
db_manager_path = os.path.abspath('/Users/kwonyeojoon0221/Desktop/Visual_Studio_Code/project/project_clang/ui_1/db_manager/db_manager')
...
def save_timeline():
    ...
    date = str(data.get('selectedDate', ''))
